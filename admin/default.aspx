...
<head runat="server">
    <title>管理员登录页</title>
    <link href="~/publish/images/Default.css" type="text/css" rel="stylesheet" />
    <link href="~/publish/images/xtree.css" type="text/css" rel="stylesheet" />
    <link href="~/publish/images/User_Login.css" type="text/css" rel="stylesheet" />
                    ...
                    <dd id="user_main">
                        <ul>
                            ...
                            <li class="user_main_r">
                                <asp:ImageButton ID="IbtnEnter" OnClick="IbtnEnter_Click" runat="server" CssClass="IbtnEnterCssClass" ImageUrl="~/publish/images/user_botton.gif" />
                            </li>
                        </ul>
                        <dd id="user_bottom">
                            <ul>
